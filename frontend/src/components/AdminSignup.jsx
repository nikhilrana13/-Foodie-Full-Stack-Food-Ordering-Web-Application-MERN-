...
const AdminSignup = () => {
    ...
    const onSubmit = async(data)=>{
        const Admininfo = {
         ...
         try {
            const response = await axios.post("http://localhost:4000/api/admin/signup",Admininfo,{withCredentials:true});
            if(response.data){
  ...
  return (
    ...
    <input type="text" name="name" className='px-3 py-2 w-full border border-gray-800 rounded-sm' placeholder='Name'
